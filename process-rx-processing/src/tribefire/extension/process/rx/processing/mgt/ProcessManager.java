...
import tribefire.extension.process.rx.processing.mgt.processor.ClearProcessLogProcessor;
import tribefire.extension.process.rx.processing.mgt.processor.ClearProcessLogsProcessor;
import tribefire.extension.process.rx.processing.mgt.processor.GetProcessListProcessor;
import tribefire.extension.process.rx.processing.mgt.processor.GetProcessLogByScalarFiltersProcessor;
import tribefire.extension.process.rx.processing.mgt.processor.GetProcessLogProcessor;
import tribefire.extension.process.rx.processing.mgt.processor.HandleProcessProcessor;
import tribefire.extension.process.rx.processing.mgt.processor.NotifyProcessActivityProcessor;
import tribefire.extension.process.rx.processing.mgt.processor.RecoverProcessProcessor;
import tribefire.extension.process.rx.processing.mgt.processor.ResumeProcessProcessor;
import tribefire.extension.process.rx.processing.mgt.processor.ReviveProcessesProcessor;
import tribefire.extension.process.rx.processing.mgt.processor.StartProcessProcessor;
import tribefire.extension.process.rx.processing.mgt.processor.WaitForProcessProcessor;
import tribefire.extension.process.rx.processing.mgt.processor.WaitForProcessesProcessor;
...
public class ProcessManager extends AbstractDispatchingAccessRequestProcessor<ProcessManagerRequest, Object> implements Worker, LifecycleAware, ProcessManagerConstants  {
	...
	@Required
	public void setProcessDefinitionResolver(tribefire.extension.process.rx.api.ProcessDefinitionResolver processDefinitionResolver) {
		processManagerContext.processDefinitionResolver = processDefinitionResolver;
	}

	@Required
	public void setProcessExpertResolver(tribefire.extension.process.rx.api.ProcessExpertResolver processExpertResolver) {
		processManagerContext.processExpertResolver = processExpertResolver;
	}
